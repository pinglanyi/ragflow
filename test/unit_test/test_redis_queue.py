...
class RedisQueueTest(unittest.TestCase):
    def test_queue_product_backs_off_between_transient_failures(self):
        ...
        redis = Mock()
        redis.xadd.side_effect = [ConnectionError("starting"), ConnectionError("starting"), "message-id"]
        ...
        self.assertEqual(redis.xadd.call_count, 3)
        self.assertEqual(namespace["sleep"].call_args_list, [unittest.mock.call(1), unittest.mock.call(2)])
